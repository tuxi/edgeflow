...
type WebSocketMessage_InstrumentTradingList struct {
	// 包含币种和最新价格的交易信息集合
	InstrumentTradingList *CryptoInstrumentTradingArray `protobuf:"bytes,9,opt,name=instrument_trading_list,json=instrumentTradingList,proto3,oneof"`
}
...
var file_market_data_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x8f, 0x05, 0x0a, 0x10, 0x57, 0x65, 0x62, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x4d,
	...
	0x6b, 0x65, 0x72, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x3e, 0x0a, 0x0c, 0x6b, 0x6c, 0x69, 0x6e,
...
var file_market_data_proto_depIdxs = []int32{
	...
	2,  // 8: marketdata.WebSocketMessage.kline_update:type_name -> marketdata.WsKlineUpdate
	7,  // 9: marketdata.WebSocketMessage.sort_update:type_name -> marketdata.SortUpdate
	3,  // 10: marketdata.WebSocketMessage.error_message:type_name -> marketdata.ErrorMessage
	4,  // 11: marketdata.WebSocketMessage.instrument_list:type_name -> marketdata.InstrumentListUpdate
	5,  // 12: marketdata.WebSocketMessage.instrument_status_update:type_name -> marketdata.InstrumentUpdate
	11, // 13: marketdata.WebSocketMessage.instrument_metadata:type_name -> marketdata.CryptoInstrumentMetadata
	10, // 14: marketdata.WebSocketMessage.instrument_trading_list:type_name -> marketdata.CryptoInstrumentTradingArray
